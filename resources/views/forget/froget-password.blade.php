...
<div class="container d-flex flex-column flex-md-row align-items-center p-3 " style="justify-content: center; align-items:center; align-items:center">
  ...
  <div class="row d-flex flex-row">
    <div class="col">
      <a href="/" style="text-decoration:none; color:black; margin-left:0%; margin-right:10%"><img width="24" height="24" src="https://img.icons8.com/material-rounded/24/back--v1.png"/>Back</a>
    </div>
    <div class="col">
      
    </div>

      <form action="/forget-password/save" method="POST" class="mb-0 pt-2 pt-md-0" style="text-align: center; justify-content:center; align-items:center">
        @csrf
        @method('POST')
