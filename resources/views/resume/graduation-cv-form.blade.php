...
@endif
  ...
  <div>
    ...
    <form action="/delete-graduation/{{$graduation->id}}/{{auth()->user()->id}}" method="POST" id="registration-form">
      @csrf
      @method('DELETE')
    ...
    @can('update' , $graduation)
    <form action="/edit-graduation/{{$graduation->id}}/{{auth()->user()->id}}" method="GET" id="registration-form">
