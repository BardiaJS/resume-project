...
<html lang="en">
  ...
  <body style="background-image: url('/images/fourth-template.png'); color:white; text-align:center; background-size:cover">
    ...
    <h5 style="color: rgb(252, 210, 26)">{{$personal->name}}</h5>
    <h4 style="font-weight: bold">Family Name:</h4>
    <h5 style="color: rgb(252, 210, 26)">{{$personal->familyName}}</h5>
    <h4 style="font-weight: bold">Age:</h4>
    <h5 style="color: rgb(252, 210, 26)">{{$personal->age}}</h5>
    <h4 style="font-weight: bold">Gender:</h4>
    <h5 style="color: rgb(252, 210, 26)">{{$personal->gender}}</h5>
    <h4 style="font-weight: bold">Military:</h4>
    <h5 style="color: rgb(252, 210, 26)">{{$personal->military}}</h5>
    ...
    <h5 style="color: rgb(252, 210, 26)">{{$graduation->level}}</h5>
    <h4 style="font-weight: bold">major in high school:</h4>
    <h5 style="color: rgb(252, 210, 26)">{{$graduation->high_school_major}}</h5>
    <h4 style="font-weight: bold">major in university:</h4>
    <h5 style="color: rgb(252, 210, 26)">{{$graduation->university_major}}</h5>
    <h4 style="font-weight: bold">university name:</h4>
    <h5 style="color: rgb(252, 210, 26)">{{$graduation->university_name}}</h5>
    @endforeach
    ...
    <ol>
      @foreach ($skills as $skill)
        <li style="color: rgb(252, 210, 26)">{{$skill->title}}: {{$skill->body}}</li><br>
      @endforeach
       ...
       <div class="title">
        ...
        <h5 style="color: rgb(252, 210, 26)"> {{$experience->body}}</h5>
